	...
	<body>
		...
		<nav aria-label="breadcrum">
			<ol class="breadcrumb bg-success">
				<li class="breadcrumb-item active text-white font-weight-bold titre" aria-current="page">Histoire - Jeux</li>
			</ol>
		</nav>
		...
		<table class="table font-weight-bold text-center">
		  ...
		  <tr class="bg-success text-white text-center table-fontlarge">
			  <td>Histoire 1</td>
			  <td><a href="laprehistoire_jeu.php" class="col table-fontlarge"><b style="font-family:perso">La préhistoire</b></a></td>
			</tr>
		  </tbody>
		</table>
