<html>
	<head>
		...
		<audio id="1"><source src="audio\ilya.mp3"></source><source src="francais\audio\ilya.ogg"></source></audio>
	</head>
<?php
			include 'menu.php';
		?>
...
function go()
{
	...
	{
		document.getElementById("operation").innerHTML="Click on the right number";
	}
