<html> 	
	...
	<script type="text/javascript" src="francais_dictees_dictee18.js"></script>

	<audio id="1"><source src="francais\audio\lalangue.mp3"></source><source src="francais\audio\lalangue.ogg"></source></audio>
	...
	<body>
		...
		<nav aria-label="breadcrum">
			<ol class="breadcrumb bg-danger">
				<li class="breadcrumb-item active text-white font-weight-bold titre" aria-current="page">Français - Dictées - Dictée 18</li>
			</ol>
		</nav>		
		<br>		
