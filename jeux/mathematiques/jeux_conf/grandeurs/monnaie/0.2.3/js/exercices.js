	...
	if (typExercice=="typComposer") {
		...
		if (valComposer>=500) {
			...
			for (var i = 0; i < nb500e; i++) {
				str += '<img class="b500 monnaie slidRightRot" src="img/billet-500e.png" width="154.32">';
			}
		}
		...
		if (valComposer>=200) {
			...
			for (var i = 0; i < nb200e; i++) {
				str += '<img class="b200 monnaie slidRightRot" src="img/billet-200e.png" width="147.5">';
			}
		}
		...
		if (valComposer>=100) {
			...
			for (var i = 0; i < nb100e; i++) {
				str += '<img class="b100 monnaie slidRightRot" src="img/billet-100e.png" width="142">';
			}
		}
		...
		if (valComposer>=50) {
			...
			for (var i = 0; i < nb50e; i++) {
				str += '<img class="b50 monnaie slidRightRot" src="img/billet-50e.png" width="135.22">';
			}
		}
		...
		if (valComposer>=20) {
			...
			for (var i = 0; i < nb20e; i++) {
				str += '<img class="b20 monnaie slidRightRot" src="img/billet-20e.png" width="122.18">';
			}
		}
		...
		if (valComposer>=10) {
			...
			for (var i = 0; i < nb10e; i++) {
				str += '<img class="b10 monnaie slidRightRot" src="img/billet-10e.png" width="122.73">';
			}
		}
		...
		if (valComposer>=5) {
			...
			for (var i = 0; i < nb5e; i++) {
				str += '<img class="b5 monnaie slidRightRot" src="img/billet-5e.png" width="115.91">';
			}
		}
		...
		if (valComposer>=2) {
			...
			for (var i = 0; i < nb2e; i++) {
				str += '<img class="p2 monnaie slidRightRot" src="img/piece-2e.png" width="70">';
			}
		}
		...
		if (valComposer>=1) {
			...
			for (var i = 0; i < nb1e; i++) {
				str += '<img class="p1 monnaie slidRightRot" src="img/piece-1e.png" width="62.5">';
			}
		}
		...
		if (valComposer>=0.5) {
			...
			for (var i = 0; i < nb50c; i++) {
				str += '<img class="p50c monnaie slidRightRot" src="img/piece-50c.png" width="62.5">';
			}
		}
		...
		if (valComposer>=0.2) {
			...
			for (var i = 0; i < nb20c; i++) {
				str += '<img class="p20c monnaie slidRightRot" src="img/piece-20c.png" width="60.5">';
			}
		}
		...
		if (valComposer>=0.1) {
			...
			for (var i = 0; i < nb10c; i++) {
				str += '<img class="p10c monnaie slidRightRot" src="img/piece-10c.png" width="54.5">';
			}
		}
		...
		if (valComposer>=0.05) {
			...
			for (var i = 0; i < nb5c; i++) {
				str += '<img class="p5c monnaie slidRightRot" src="img/piece-5c.png" width="54.4">';
			}
		}
		...
		if (valComposer>=0.02) {
			...
			for (var i = 0; i < nb2c; i++) {
				str += '<img class="p2c monnaie slidRightRot" src="img/piece-2c.png" width="49.7">';
			}
		}
		...
		if (valComposer>=0.01) {
			...
			for (var i = 0; i < nb1c; i++) {
				str += '<img class="p1c monnaie slidRightRot" src="img/piece-1c.png" width="45.2">';
			}
		}
