...
function generer() {
	...
	function emprunter(e) {
		...
		if (e=="Um") {
			if (t1Uc==0 && t1Ucemp!=10) {
				$("#t1Um").append('<div class="bullBox"><div class="bullL">Emprunte d\'abord un dixième</div><div class="flEmpL">➜</div></div>');
			}
			else {
				$("#t1Um").append('<div class="bullBox"><div class="bull">Clique pour emprunter un centième</div><div class="flEmp">➜</div></div>');
				$("#t1Um .ptR, .inptPropUm .imp").click(function(){
					...
					$(".inptRepUc").append('<div class="empUc emp">'+(t1Ucemp-1)+'</div><div class="barre">╱</div>');
					t1Umemp = t1Um + 10;
				});
			}
			...
			if (t1Ud==0 && t1Udemp!=10) {
				$("#t1Uc").append('<div class="bullBox"><div class="bullL">Emprunte d\'abord une unité</div><div class="flEmpL">➜</div></div>');
				$("#t1Uc .flEmpL").css("left", "-3.3em");
			}
			else if (t1Uc!=0 && (t1Umemp-repUm)<t2Um) {
				$("#t1Uc").append('<div class="bullBox"><div class="bullR">Commence par les millièmes</div><div class="flEmpR">▾</div></div>');
			}
			else {
				$("#t1Uc").append('<div class="bullBox"><div class="bull">Clique pour emprunter un dixième</div><div class="flEmp">➜</div></div>');
				$("#t1Uc .ptR, .inptPropUc .imp").click(function(){
					...
					if (totUm<0 && t1Uc!=0) {
						$("#t1Uc .ajt").css("top","-.98em");
					}
					$(".inptRepUd").append('<div class="empUc emp">'+(t1Udemp-1)+'</div><div class="barre">╱</div>');
					t1Ucemp = t1Uc + 10;
				});
			}
			...
			if (t1U==0 && t1Uemp!=10) {
				$("#t1Ud").append('<div class="bullBox"><div class="bullL">Emprunte d\'abord une dizaine</div><div class="flEmpL">➜</div></div>');
				$("#t1Ud .flEmpL").css("left", "-3.64em");
			}
			else if (t1Ud!=0 && (t1Ucemp-repUc)<t2Uc) {
				$("#t1Ud").append('<div class="bullBox"><div class="bullR">Commence par les centièmes</div><div class="flEmpR">▾</div></div>');
			}
			else {
				$("#t1Ud").append('<div class="bullBox"><div class="bull">Clique pour emprunter une unité</div><div class="flEmp">➜</div></div>');
				$("#t1Ud .ptR, .inptPropUd .imp").click(function(){
					...
					if (totUc<0 && t1Ud!=0) {
						$("#t1Ud .ajt").css("top","-.98em");
					}
					$(".inptRepU").append('<div class="empUd emp">'+(t1Uemp-1)+'</div><div class="barre">╱</div>');
					t1Udemp = t1Ud + 10;
				});
				$("#t1Ud .flEmp").css("left", "-.8em");
			}
			...
			if (t1D==0 && t1Demp!=10) {
				$("#t1U").append('<div class="bullBox"><div class="bullL">Emprunte d\'abord une centaine</div><div class="flEmpL">➜</div></div>');
			}
			else if (t1U!=0 && (t1Udemp-repUd)<t2Ud) {
				$("#t1U").append('<div class="bullBox"><div class="bullR">Commence par les dixièmes</div><div class="flEmpR">▾</div></div>');
				$("#t1U .flEmpR").css("right", "-2.3em");
			}
			else {
				$("#t1U").append('<div class="bullBox"><div class="bull">Clique pour emprunter une dizaine</div><div class="flEmp">➜</div></div>');
				$("#t1U .ptR, .inptPropU .imp").click(function(){
					...
					if (totUd<0 && t1U!=0) {
						$("#t1U .ajt").css("top","-.98em");
					}
					$(".inptRepD").append('<div class="empU emp">'+(t1Demp-1)+'</div><div class="barre">╱</div>');
					t1Uemp = t1U + 10;
				});
			}
			...
			if (t1C==0 && t1Cemp!=10) {
				$("#t1D").append('<div class="bullBox"><div class="bullL">Emprunte d\'abord mille</div><div class="flEmpL">➜</div></div>');
			}
			else if (t1D!=0 && (t1Uemp-repU)<t2U) {
				$("#t1D").append('<div class="bullBox"><div class="bullR">Commence par les unités</div><div class="flEmpR">▾</div></div>');
			}
			else {
				$("#t1D").append('<div class="bullBox"><div class="bull">Clique pour emprunter une centaine</div><div class="flEmp">➜</div></div>');
				$("#t1D .ptR, .inptPropD .imp").click(function(){
					...
					if (totU<0 && t1D!=0) {
						$("#t1D .ajt").css("top","-.98em");
					}						
					$(".inptRepC").append('<div class="empD emp">'+(t1Cemp-1)+'</div><div class="barre">╱</div>');
					t1Demp = t1D + 10;
				});
			}
			...
			if (t1M==0) {
				$("#t1C").append('<div class="bullBox"><div class="bullL">Emprunte d\'abord mille</div><div class="flEmpL">➜</div></div>');
			}
			else if (t1C!=0 && (t1Demp-repD)<t2D) {
				$("#t1C").append('<div class="bullBox"><div class="bullR">Commence par les dizaines</div><div class="flEmpR">▾</div></div>');
			}
			else {
				$("#t1C").append('<div class="bullBox"><div class="bull">Clique pour emprunter mille</div><div class="flEmp">➜</div></div>');
				$("#t1C .ptR, .inptPropC .imp").click(function(){
					...
					if (totD<0 && t1C!=0) {
						$("#t1C .ajt").css("top","-.98em");
					}						
					$(".inptRepM").append('<div class="empC emp">'+(t1M-1)+'</div><div class="barre">╱</div>');
					t1Cemp = t1C + 10;
				});
			}
