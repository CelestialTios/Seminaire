...
function correction1()
{
		...
		switch(tour)
		{
			...
			var juste1=100*Math.floor(nbr1/100);juste2=10*Math.floor((nbr1-100*Math.floor(nbr1/100))/10);juste3=nbr1-100*Math.floor(nbr1/100)-10*Math.floor((nbr1-100*Math.floor(nbr1/100))/10);
			...
			{
			document.getElementById("correction1").innerHTML ="Erreur(s) : "+nbr1+" = "+juste1+" + "+juste2+" + "+juste3;
			}
			break;
			
			case 2 :
			document.getElementById("correction2").style.display = "";
			var juste4=100*Math.floor(nbr2/100);juste5=10*Math.floor((nbr2-100*Math.floor(nbr2/100))/10);juste6=nbr2-100*Math.floor(nbr2/100)-10*Math.floor((nbr2-100*Math.floor(nbr2/100))/10);
			...
			{
			document.getElementById("correction2").innerHTML ="Erreur(s) : "+nbr2+" = "+juste4+" + "+juste5+" + "+juste6;
			}
			break;
			
			case 3 :
			document.getElementById("correction3").style.display = "";
			var juste7=100*Math.floor(nbr3/100);juste8=10*Math.floor((nbr3-100*Math.floor(nbr3/100))/10);juste9=nbr3-100*Math.floor(nbr3/100)-10*Math.floor((nbr3-100*Math.floor(nbr3/100))/10);
			...
			{
			document.getElementById("correction3").innerHTML ="Erreur(s) : "+nbr3+" = "+juste7+" + "+juste8+" + "+juste9;
			}
			break;
			
			case 4 :
			document.getElementById("correction4").style.display = "";
			var juste10=100*Math.floor(nbr4/100);juste11=10*Math.floor((nbr4-100*Math.floor(nbr4/100))/10);juste12=nbr4-100*Math.floor(nbr4/100)-10*Math.floor((nbr4-100*Math.floor(nbr4/100))/10);
			...
			{
			document.getElementById("correction4").innerHTML ="Erreur(s) : "+nbr4+" = "+juste10+" + "+juste11+" + "+juste12;
			}
			break;
			
			case 5 :
			document.getElementById("correction5").style.display = "";
			var juste13=100*Math.floor(nbr5/100);juste14=10*Math.floor((nbr5-100*Math.floor(nbr5/100))/10);juste15=nbr5-100*Math.floor(nbr5/100)-10*Math.floor((nbr5-100*Math.floor(nbr5/100))/10);
			...
			{
			document.getElementById("correction5").innerHTML ="Erreur(s) : "+nbr5+" = "+juste13+" + "+juste14+" + "+juste15;
			}
			break;
		}
		tour++;
