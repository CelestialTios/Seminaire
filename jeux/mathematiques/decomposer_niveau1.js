...
function correction1()
{
		...
		switch(tour)
		{
			...
			var juste1=10*Math.floor(nbr1/10);juste2=nbr1-10*Math.floor(nbr1/10);
			...
			{
			document.getElementById("correction1").innerHTML = "Erreur(s) : "+nbr1+" = "+juste1+" + "+juste2;
			}
			break;
			
			case 2 :
			document.getElementById("correction2").style.display = "";
			var juste3=10*Math.floor(nbr2/10);juste4=nbr2-10*Math.floor(nbr2/10);
			...
			{
			document.getElementById("correction2").innerHTML = "Erreur(s) : "+nbr2+" = "+juste3+" + "+juste4;
			}
			break;
			
			case 3 :
			document.getElementById("correction3").style.display = "";
			var juste5=10*Math.floor(nbr3/10);juste6=nbr3-10*Math.floor(nbr3/10);
			...
			{
			document.getElementById("correction3").innerHTML = "Erreur(s) : "+nbr3+" = "+juste5+" + "+juste6;
			}
			break;
			
			case 4 :
			document.getElementById("correction4").style.display = "";
			var juste7=10*Math.floor(nbr4/10);juste8=nbr4-10*Math.floor(nbr4/10);
			...
			{
			document.getElementById("correction4").innerHTML = "Erreur(s) : "+nbr4+" = "+juste7+" + "+juste8;
			}
			break;
			
			case 5 :
			document.getElementById("correction5").style.display = "";
			var juste9=10*Math.floor(nbr5/10);juste10=nbr5-10*Math.floor(nbr5/10);
			...
			{
			document.getElementById("correction5").innerHTML = "Erreur(s) : "+nbr5+" = "+juste9+" + "+juste10;
			}
			break;
		}
		tour++;
