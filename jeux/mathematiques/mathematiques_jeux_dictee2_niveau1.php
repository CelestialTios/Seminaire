<html> 	
	...
	<script type="text/javascript" src="mathematiques_jeux_dictee2_niveau1.js"></script>
	...
	<body>
		...
		<button type="button" class="btn btn-success consignes2" onclick="jecoute();"id="jecoute">Clique ici pour écouter le nombre puis écris le en chiffre.</button>
		<br><br>
