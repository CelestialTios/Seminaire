<html>
	<head>
		...
		<meta name="description" content="Jeu de la table de multiplication de 5, niveau expert" />
		<meta charset="utf-8" />
		<title>Table des 5 niveau expert</title>
	</head>
<?php
			include 'menu.php';
		?>
	...
	<body onload="rebours();">
		...
		<div id="encore" style="display:none;position:absolute; top:200px;left:300px">
			<form action="tablede5niveau3.php" method="POST">
