<html>
	...
	<body>
		<div id="global">
			<div class="entete">
				<h1 style="text-align:center;margin-bottom:20px;">Carré magique</h1>
			</div>
			...
			<form action="carre_magique.php" autocomplete="off" method="post">
				<table>
					<tr>
						<td class="cellule" style="font-weight:bold;color:maroon;">2
							<input type="hidden" name="cellule11" value="2" />
						</td>
						<td class="cellule" style="font-weight:bold;color:maroon;">2
							<input type="hidden" name="cellule12" value="2" />
						</td>
						<td class="cellule">
							<input type="text" name="cellule13" value="" size="1"/>
						</td>
					</tr>
					<tr>
						<td class="cellule" style="font-weight:bold;color:maroon;">6
							<input type="hidden" name="cellule21" value="6" />
						</td>
						<td class="cellule">
							<input type="text" name="cellule22" value="" size="1"/>
						</td>
						<td class="cellule">
							<input type="text" name="cellule23" value="" size="1"/>
						</td>
					</tr>
					<tr>
						<td class="cellule">
							<input type="text" name="cellule31" value="" size="1"/>
						</td>
						<td class="cellule">
							<input type="text" name="cellule32" value="" size="1"/>
						</td>
						<td class="cellule">
							<input type="text" name="cellule33" value="" size="1"/>
						</td>
					</tr>
					<tr>
						<td colspan="3">
						<input id="envoi" name="envoi" type="submit" alt="Vérifier" value="Vérifier" />
					</td>
				</tr>
			</table>
			</form>
			<p>
				<img style="margin:0" src="../images/icon-pdf.png" alt="" /> 
				<a href="dompdf1.php/carre.pdf" target="carrePDF">Exporter en PDF</a>
			</p>
			<p>
				<img src="fleche.gif" alt="- "/>&nbsp;Nouveau carré magique :
			</p>
