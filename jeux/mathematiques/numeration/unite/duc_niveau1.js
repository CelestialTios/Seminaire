...
function go()
{
		...
		{
		case 1 :
		nbr1=Math.floor(Math.random()*99)+1;
		...
		case 2 :
		nbr2=Math.floor(Math.random()*99)+1;
		...
		case 3 :
		nbr3=Math.floor(Math.random()*99)+1;
		...
		case 4 :
		nbr4=Math.floor(Math.random()*99)+1;
		...
		case 5 :
		nbr5=Math.floor(Math.random()*99)+1;
...
function correction1()
{
		...
		switch(tour)
		{
			...
			var juste1=1*Math.floor(nbr1/10);juste2=nbr1-10*Math.floor(nbr1/10);
			...
			{
			document.getElementById("correction1").innerHTML = "Erreur : Dizaine(s) = "+juste1+" et unité(s) = "+juste2;
			}
			break;
			
			case 2 :
			document.getElementById("correction2").style.display = "";
			var juste3=1*Math.floor(nbr2/10);juste4=nbr2-10*Math.floor(nbr2/10);
			...
			{
			document.getElementById("correction2").innerHTML = "Erreur : Dizaine(s) = "+juste3+" et unité(s) = "+juste4;
			}
			break;
			
			case 3 :
			document.getElementById("correction3").style.display = "";
			var juste5=1*Math.floor(nbr3/10);juste6=nbr3-10*Math.floor(nbr3/10);
			...
			{
			document.getElementById("correction3").innerHTML = "Erreur : Dizaine(s) = "+juste5+" et unité(s) = "+juste6;
			}
			break;
			
			case 4 :
			document.getElementById("correction4").style.display = "";
			var juste7=1*Math.floor(nbr4/10);juste8=nbr4-10*Math.floor(nbr4/10);
			...
			{
			document.getElementById("correction4").innerHTML = "Erreur : Dizaine(s) = "+juste7+" et unité(s) = "+juste8;
			}
			break;
			
			case 5 :
			document.getElementById("correction5").style.display = "";
			var juste9=1*Math.floor(nbr5/10);juste10=nbr5-10*Math.floor(nbr5/10);
			...
			{
			document.getElementById("correction5").innerHTML = "Erreur : Dizaine(s) = "+juste9+" et unité(s) = "+juste10;
			}
			break;
		}
		tour++;
