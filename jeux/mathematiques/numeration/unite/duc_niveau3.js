...
function correction1()
{
		...
		switch(tour)
		{
			...
			{
			document.getElementById("correction1").innerHTML ="centaine(s) = "+juste1+" dizaine(s) = "+juste2+" unité(s) = "+juste3;
			}
			break;
			...
			{
			document.getElementById("correction2").innerHTML ="centaine(s) = "+juste4+" dizaine(s) = "+juste5+" unité(s) = "+juste6;
			}
			break;
			...
			{
			document.getElementById("correction3").innerHTML ="centaine(s) = "+juste7+" dizaine(s) = "+juste8+" unité(s) = "+juste9;
			}
			break;
			...
			{
			document.getElementById("correction4").innerHTML ="centaine(s) = "+juste10+" dizaine(s) = "+juste11+" unité(s) = "+juste12;
			}
			break;
			...
			{
			document.getElementById("correction5").innerHTML ="centaine(s) = "+juste13+" dizaine(s) = "+juste14+" unité(s) = "+juste15;
			}
			break;
		}
		tour++;
