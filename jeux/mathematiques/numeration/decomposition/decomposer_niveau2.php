...
<script type="text/javascript" src="decomposer_niveau2.js"></script>
...
<script src="../../js/bootstrap.min.js"></script>
	...
	<div>
		<div class="presentation">
			...
			<button class="btn btn-success consignes" id="consigne" type="button">Décompose le nombre en paquets de centaines, en paquets de dizaines et en paquets d'unités</button>
			...
			<button class="btn btn-success consignes2" type="button"> + </a></button><INPUT type="Nom du champ" placeholder="?" id="reponse11"></input>

			<button class="btn btn-success consignes2" type="button"> + </a></button><INPUT type="Nom du champ" placeholder="?" id="reponse12"></input>
			</div>
			...
			<button class="btn btn-success consignes2" type="button"> = </a></button><INPUT type="Nom du champ" placeholder="?" id="reponse13"></input>

			<button class="btn btn-success consignes2" type="button"> + </a></button><INPUT type="Nom du champ" placeholder="?" id="reponse14"></input>

			<button class="btn btn-success consignes2" type="button"> + </a></button><INPUT type="Nom du champ" placeholder="?" id="reponse15"></input>
			</div>
