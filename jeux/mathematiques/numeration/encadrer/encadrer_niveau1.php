...
<script type="text/javascript" src="encadrer_niveau1.js"></script>
...
<script src="../../js/bootstrap.min.js"></script>
	...
	<div>
		<div class="presentation">
			...
			<button class="btn btn-success consignes" type="button" id="consigne">Encadre à l'unité inférieur et à l'unité supérieur.</button>
