...
<script type="text/javascript" src="encadrer_niveau3.js"></script>
...
<script src="../../js/bootstrap.min.js"></script>
	...
	<div>
		<div class="presentation">
			...
			<button class="btn btn-success consignes" type="button" id="consigne">Encadre à la centaine inférieur et à la centaine supérieur.</button>
			...
			<div id="exo1" style="display:none" class="encadrecasemillion">
				<INPUT type="Nom du champ" placeholder="?" id="reponse1"></input>
			<button class="btn btn-info consignes2" type="button"> < </a></button>
			<button class="btn btn-info consignes2" type="button"><div id="nbr1" text-white font-weight-bold"></div></a></button>
			<button class="btn btn-info consignes2" type="button"> < </a></button>
				<INPUT type="Nom du champ" placeholder="?" id="reponse2"></input>
			</div>
			...
			<div id="exo2" style="display:none" class="encadrecasemillion">
				<INPUT type="Nom du champ" placeholder="?" id="reponse3"></input>
			<button class="btn btn-info consignes2" type="button"> < </a></button>
			<button class="btn btn-info consignes2" type="button"><div id="nbr2" text-white font-weight-bold"></div></a></button>
			<button class="btn btn-info consignes2" type="button"> < </a></button>
				<INPUT type="Nom du champ" placeholder="?" id="reponse4"></input>
			</div>
			<div>
			...
			<div id="exo3" style="display:none" class="encadrecasemillion">
				<INPUT type="Nom du champ" placeholder="?" id="reponse5"></input>
			<button class="btn btn-info consignes2" type="button"> < </a></button>
			<button class="btn btn-info consignes2" type="button"><div id="nbr3" text-white font-weight-bold"></div></a></button>
			<button class="btn btn-info consignes2" type="button"> < </a></button>
				<INPUT type="Nom du champ" placeholder="?" id="reponse6"></input>
			</div>
			<div>
			...
			<div id="exo4" style="display:none" class="encadrecasemillion">
				<INPUT type="Nom du champ" placeholder="?" id="reponse7"></input>
			<button class="btn btn-info consignes2" type="button"> < </a></button>
			<button class="btn btn-info consignes2" type="button"><div id="nbr4" text-white font-weight-bold"></div></a></button>
			<button class="btn btn-info consignes2" type="button"> < </a></button>
				<INPUT type="Nom du champ" placeholder="?" id="reponse8"></input>
			</div>
			<div>
			...
			<div id="exo5" style="display:none" class="encadrecasemillion">
				<INPUT type="Nom du champ" placeholder="?" id="reponse9"></input>
			<button class="btn btn-info consignes2" type="button"> < </a></button>
			<button class="btn btn-info consignes2" type="button"><div id="nbr5" text-white font-weight-bold"></div></a></button>
			<button class="btn btn-info consignes2" type="button"> < </a></button>
				<INPUT type="Nom du champ" placeholder="?" id="reponse10"></input>
			</div>
			<div>
