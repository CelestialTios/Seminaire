...
<script type="text/javascript" src="mathematiques_jeux_ranger_niveau1.js"></script>
...
<script src="../../js/bootstrap.min.js"></script>
	...
	<div class="page" id="page">
		<div class="presentation">
			...
			<button class="btn btn-success consignes" type="button" id="consigne">Range les nombres du plus petit au plus grand<br>Tu peux colorier chaque nombre en cliquant dessus.<br>Ca t'aidera à te souvenir des nombres déjà placés.</button>
