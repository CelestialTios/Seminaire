...
<script type="text/javascript" src="duc_niveau1.js"></script>
...
<script src="../../js/bootstrap.min.js"></script>
	...
	<div>
		<div class="presentation">
			...
			<button class="btn btn-success consignes" type="button" id="consigne">Indique quel est le chiffre des dizaines et des unités</button>
			...
			<button class="btn btn-success consignes2" type="button">dizaine(s)</a></button><INPUT type="Nom du champ" placeholder="?" id="reponse1"></input>

			<button class="btn btn-success consignes2" type="button">unité(s)</a></button><INPUT type="Nom du champ" placeholder="?" id="reponse2"></input>
			</div>
			...
			<button class="btn btn-success consignes2" type="button">dizaine(s)</a></button><INPUT type="Nom du champ" placeholder="?" id="reponse3"></input>

			<button class="btn btn-success consignes2" type="button">unité(s)</a></button><INPUT type="Nom du champ" placeholder="?" id="reponse4"></input>
			</div>
			...
			<button class="btn btn-success consignes2" type="button">dizaine(s)</a></button><INPUT type="Nom du champ" placeholder="?" id="reponse7"></input>

			<button class="btn btn-success consignes2" type="button">unité(s)</a></button><INPUT type="Nom du champ" placeholder="?" id="reponse8"></input>
			</div>
			...
			<button class="btn btn-success consignes2" type="button">dizaine(s)</a></button><INPUT type="Nom du champ" placeholder="?" id="reponse9"></input>

			<button class="btn btn-success consignes2" type="button">unité(s)</a></button><INPUT type="Nom du champ" placeholder="?" id="reponse10"></input>
			</div>
