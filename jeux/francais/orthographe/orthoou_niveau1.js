...
var vMot1="Tu préfère un fruit … un yaourt.";
var vMot2="Nous allons à la plage … au cinéma.";
var vMot3="Tu lis … tu joues ?";
var vMot4="Est-ce qu’il pleut … est-ce qu’il neige ?";
var vMot5="Je vais voir, la robe … la jupe, je ne sais pas.";
var vMot6="Nous allons apercevoir des baleines ou des dauphins.";
var vMot7="C’est à la framboise … à la fraise.";
var vMot8="Je prends ce livre … l’autre.";
var vMot9="Tu donnes une poupée …une peluche.";
var vMot10="Mon frère va à l’université … dans une école d’ingénieur.";
var vMot11="Il sera avocat … juge.";
var vMot12="Ce midi,  c’est soupe ou salade,  toi de choisir.";
var vMot13="Demain, il y aura de la pluie … des éclaircie.";
var vMot14="La maîtresse prend un café … du thé.";
var vMot15="Elle enverra un message … elle appellera.";
var vMot16="… vas-tu comme ça ?";
var vMot17="J’irai … tu iras.";
var vMot18="Je chante … tu as dansé la semaine dernière.";
var vMot19="Je dors …?";
var vMot20="… est-elle ? ";
var vMot21="Tu vois cette information où ?";
var vMot22="… habitez-vous ? ";
var vMot23="Je cherche … se trouve le trésor sur l’île.";
var vMot24="Nous allons … tu souhaites aller depuis des années.";
var vMot25="L’oiseau va … le vent le pousse.";
var vMot26="… vivent les panthères ?";
var vMot27="Range tes chaussures … il y a de la place.";
var vMot28="… portes-tu ces pots de confiture ?";
var vMot29="… se passe l’histoire ?";
var vMot30="Maman, … es-tu ?";
...
function correction1()
{
		switch(tour)
		{
			case 1 :
				...
				if(nbr1>15)
				{
				document.getElementById("correction1").innerHTML = "Erreur, il fallait choisir : où ";
				document.getElementById("go1").style.display = "";
				document.getElementById("go1blanc").style.display = "none";
				tour++;
				}
...
function correction2()
{
		switch(tour)
		{
			case 1 :
				...
				if(nbr1<16)
				{
				document.getElementById("correction1").innerHTML = "Erreur, il fallait choisir : ou ";
				document.getElementById("go1").style.display = "";
				document.getElementById("go1blanc").style.display = "none";
				tour++;
				}
