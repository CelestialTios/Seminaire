...
<script type="text/javascript" src="contraires.js"></script>
...
<title>Synonymes ou antonymes</title>
	...
	<body onload="go();">
		...
		<nav aria-label="breadcrum">
			<ol class="breadcrumb bg-danger">
				<li class="breadcrumb-item active text-white font-weight-bold" aria-current="page">Français - Jeux - Vocabulaire - les antonymes - niveau 1</li>
			</ol>
		</nav>
		<button type="button" class="btn btn-success consignes" id="consigne">Antonymes ou synonymes ?</button><br>
		...
		<br><br>
			...
			<div id="exo1" style="display:none">
				...
				<button type="button" class="btn btn-success consignes2" onclick="correction1();" id="choix1"> Synonymes </button>
				<button type="button" class="btn btn-success consignes2" onclick="correction2();" id="choix2"> Antonymes </button>
