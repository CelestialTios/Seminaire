...
<script type="text/javascript" src="phrase_niveau1.js"></script>
	...
	<body onload="go();">
		...
		<nav aria-label="breadcrum">
			<ol class="breadcrumb bg-danger">
				<li class="breadcrumb-item active text-white font-weight-bold" aria-current="page">Français - Jeux - Grammaire - La phrase - niveau 1</li>
			</ol>
		</nav>
