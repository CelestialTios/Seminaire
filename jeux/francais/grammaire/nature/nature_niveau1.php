...
<script type="text/javascript" src="nature_niveau1.js"></script>
	...
	<body onload="go();">
		...
		<nav aria-label="breadcrum">
			<ol class="breadcrumb bg-danger">
				<li class="breadcrumb-item active text-white font-weight-bold" aria-current="page">Français - Jeux - Grammaire - La nature des mots - niveau 1</li>
			</ol>
		</nav>
		<button type="button" class="btn btn-success consignes" id="consigne">Les mots sont-ils des déterminants, des noms communs ou des noms propres ?</button><br>
