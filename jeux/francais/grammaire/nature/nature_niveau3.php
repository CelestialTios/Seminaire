...
<script type="text/javascript" src="nature_niveau3.js"></script>
	...
	<body onload="go();">
		...
		<nav aria-label="breadcrum">
			<ol class="breadcrumb bg-danger">
				<li class="breadcrumb-item active text-white font-weight-bold" aria-current="page">Français - Jeux - Grammaire - La nature des mots - niveau 3</li>
			</ol>
		</nav>
		<button type="button" class="btn btn-success consignes" id="consigne">Les mots sont-ils des déterminants, des noms communs, des noms propres, des adjectifs ou des pronoms personnels ?</button><br>
		...
		<br><br>
			...
			<div id="exo1" style="display:none">
				...
				<button type="button" class="btn btn-success consignes2" onclick="correction1();" id="choix1"> Déterminant </button>
				<button type="button" class="btn btn-success consignes2" onclick="correction2();" id="choix2"> Nom commun </button>
				<button type="button" class="btn btn-success consignes2" onclick="correction3();" id="choix3"> Nom propre </button>
				<button type="button" class="btn btn-success consignes2" onclick="correction4();" id="choix4"> Adjectif </button>
				<button type="button" class="btn btn-success consignes2" onclick="correction5();" id="choix5"> Pronom personnel </button>
