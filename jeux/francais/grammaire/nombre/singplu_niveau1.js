...
var vMot17="chapeaux";
var vMot18="gorilles";
var vMot19="tricycles";
var vMot20="bateaux";
var vMot21="genoux";
var vMot22="sauterelles";
var vMot23="aubergines";
var vMot24="camionettes";
var vMot25="petites";
var vMot26="ordinateurs";
var vMot27="policières";
var vMot28="livres";
var vMot29="cultivés";
var vMot30="poilues";
...
function correction1()
{
		switch(tour)
		{
			case 1 :
				...
				if(nbr1>15)
				{
				document.getElementById("correction1").innerHTML = "Erreur, il fallait choisir : Pluriel ";
				document.getElementById("go1").style.display = "";
				document.getElementById("go1blanc").style.display = "none";
				tour++;
				}
...
function correction2()
{
		switch(tour)
		{
			case 1 :
				...
				if(nbr1<16)
				{
				document.getElementById("correction1").innerHTML = "Erreur, il fallait choisir : Singulier ";
				document.getElementById("go1").style.display = "";
				document.getElementById("go1blanc").style.display = "none";
				tour++;
				}
