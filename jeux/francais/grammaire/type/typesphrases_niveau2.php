...
<script type="text/javascript" src="typesphrases_niveau2.js"></script>
	...
	<body onload="go();">
		...
		<nav aria-label="breadcrum">
			<ol class="breadcrumb bg-danger">
				<li class="breadcrumb-item active text-white font-weight-bold" aria-current="page">Français - Jeux - Grammaire - Les types de phrases - niveau 2</li>
			</ol>
		</nav>
		<button type="button" class="btn btn-success consignes" id="consigne">Les phrases sont-elles déclaratives, interrogatives ou exclamatives ?</button><br>
