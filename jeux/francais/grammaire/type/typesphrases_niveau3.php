...
<script type="text/javascript" src="typesphrases_niveau3.js"></script>
	...
	<body onload="go();">
		...
		<nav aria-label="breadcrum">
			<ol class="breadcrumb bg-danger">
				<li class="breadcrumb-item active text-white font-weight-bold" aria-current="page">Français - Jeux - Grammaire - Les types de phrases - niveau 3</li>
			</ol>
		</nav>
		<button type="button" class="btn btn-success consignes" id="consigne">Les phrases sont-elles déclaratives, interrogatives, exclamatives ou injonctives ?</button><br>
		...
		<br><br>
			...
			<div id="exo1" style="display:none">
				...
				<button type="button" class="btn btn-success consignes2" onclick="correction1();" id="choix1"> Déclarative </button>
				<button type="button" class="btn btn-success consignes2" onclick="correction2();" id="choix2"> Interrogative </button>
				<button type="button" class="btn btn-success consignes2" onclick="correction3();" id="choix3"> Exclamative </button>
				<button type="button" class="btn btn-success consignes2" onclick="correction4();" id="choix3"> Injonctive </button>
			</div>
	<br>
