<html> 	
	...
	<script type="text/javascript" src="futur_niveau2.js"></script>
	...
	<body onload="jecoute();">
		...
		<nav aria-label="breadcrum">
			<ol class="breadcrumb bg-danger">
				<li class="breadcrumb-item active text-white font-weight-bold titre" aria-current="page">Français - Conjugaison - Les verbes au futur - niveau 2</li>
			</ol>
		</nav>		
		<br>		
