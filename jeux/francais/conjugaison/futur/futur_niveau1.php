<html> 	
	...
	<script type="text/javascript" src="futur_niveau1.js"></script>
	...
	<body onload="jecoute();">
		...
		<nav aria-label="breadcrum">
			<ol class="breadcrumb bg-danger">
				<li class="breadcrumb-item active text-white font-weight-bold titre" aria-current="page">Français - Conjugaison - Les verbes au futur - niveau 1</li>
			</ol>
		</nav>		
		<br>		
		<button type="button" class="btn btn-success consignes" id="consigne">Conjugue les verbes entre parenthèses avec le pronom personnel au futur.</button>
