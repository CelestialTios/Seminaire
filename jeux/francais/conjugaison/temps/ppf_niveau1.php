...
<script type="text/javascript" src="ppf_niveau1.js"></script>
...
<title>Infinitif ou conjugué ?</title>
	...
	<body onload="go();">
		...
		<button type="button" class="btn btn-success consignes" id="consigne">Passé, Présent ou futur ?</button><br>
		...
		<br><br>
			...
			<div id="exo1" style="display:none">
				...
				<button type="button" class="btn btn-success consignes2" onclick="correction1();" id="choix1"> Passé </button>
				<button type="button" class="btn btn-success consignes2" onclick="correction2();" id="choix2"> Présent </button>
				<button type="button" class="btn btn-success consignes2" onclick="correction3();" id="choix3"> Futur </button>
