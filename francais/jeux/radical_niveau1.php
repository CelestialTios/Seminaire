<html> 	
	...
	<script type="text/javascript" src="radical_niveau1.js"></script>
	...
	<body onload="jecoute();">
		...
		<nav aria-label="breadcrum">
			<ol class="breadcrumb bg-danger">
				<li class="breadcrumb-item active text-white font-weight-bold titre" aria-current="page">Français - Conjugaison - Quel est le radical de ce verbe ? - niveau 1</li>
			</ol>
		</nav>		
		<br>		
		<button type="button" class="btn btn-success consignes" id="consigne">Ecris le radical du verbe proposé.</button><br>
