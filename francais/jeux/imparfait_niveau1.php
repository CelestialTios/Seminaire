<html> 	
	...
	<script type="text/javascript" src="imparfait_niveau1.js"></script>
	...
	<body onload="jecoute();">
		...
		<nav aria-label="breadcrum">
			<ol class="breadcrumb bg-danger">
				<li class="breadcrumb-item active text-white font-weight-bold titre" aria-current="page">Français - Conjugaison - Les verbes à l'imparfait - niveau 1</li>
			</ol>
		</nav>		
		<br>		
