<html> 	
	...
	<script type="text/javascript" src="present_niveau2.js"></script>
	...
	<body onload="jecoute();">
		...
		<nav aria-label="breadcrum">
			<ol class="breadcrumb bg-danger">
				<li class="breadcrumb-item active text-white font-weight-bold titre" aria-current="page">Français - Conjugaison - Les verbes au présent - niveau 2</li>
			</ol>
		</nav>		
		<br>		
		<button type="button" class="btn btn-success consignes" id="consigne">Conjugue les verbes entre parenthèses avec le pronom personnel au présent.</button>
