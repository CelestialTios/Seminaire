...
<script type="text/javascript" src="phrase_niveau2.js"></script>
	...
	<body onload="go();">
		...
		<nav aria-label="breadcrum">
			<ol class="breadcrumb bg-danger">
				<li class="breadcrumb-item active text-white font-weight-bold" aria-current="page">Français - Jeux - Grammaire - La phrase - niveau 2</li>
			</ol>
		</nav>
		<button type="button" class="btn btn-success consignes" id="consigne">La phrase est-elle correcte ?</button><br>
		...
		<br><br>
			...
			<div id="exo1" style="display:none">
				...
				<button type="button" class="btn btn-success consignes2" onclick="correction1();" id="choix1"> C'est une phrase </button>
				<button type="button" class="btn btn-success consignes2" onclick="correction2();" id="choix2"> Ce n'est pas une phrase </button>
