...
<script type="text/javascript" src="singplu_niveau1.js"></script>
...
<title>Singulier ou pluriel ?</title>
	...
	<body onload="go();">
		...
		<nav aria-label="breadcrum">
			<ol class="breadcrumb bg-danger">
				<li class="breadcrumb-item active text-white font-weight-bold" aria-current="page">Français - Jeux - Grammaire - Le singulier, le pluriel - niveau 1</li>
			</ol>
		</nav>
		<button type="button" class="btn btn-success consignes" id="consigne">Les mots sont-ils au singulier ou au pluriel ?</button><br>
		...
		<br><br>
			...
			<div id="exo1" style="display:none">
				...
				<button type="button" class="btn btn-success consignes2" onclick="correction1();" id="choix1"> Singulier </button>
				<button type="button" class="btn btn-success consignes2" onclick="correction2();" id="choix2"> Pluriel </button>
