<html> 	
	...
	<script type="text/javascript" src="espaces.js"></script>
	...
	<body onload="jecoute();">
		...
		<nav aria-label="breadcrum">
			<ol class="breadcrumb bg-danger">
				<li class="breadcrumb-item active text-white font-weight-bold titre" aria-current="page">Français - Grammaire - Les mots sont tous collés !</li>
			</ol>
		</nav>		
		<br>		
		<button type="button" class="btn btn-success consignes" id="consigne">Recopie les phrases en ajoutant les espaces nécessaires.</button>
