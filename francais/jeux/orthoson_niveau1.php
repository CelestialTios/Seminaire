...
<script type="text/javascript" src="orthoson_niveau1.js"></script>
	...
	<body onload="go();">
		...
		<nav aria-label="breadcrum">
			<ol class="breadcrumb bg-danger">
				<li class="breadcrumb-item active text-white font-weight-bold" aria-current="page">Français - Jeux - Grammaire - son ou sont ? - niveau 1</li>
			</ol>
		</nav>
		<button type="button" class="btn btn-success consignes" id="consigne">Complète les phrases avec le mot son ou sont</button><br>
		...
		<br><br>
			...
			<div id="exo1" style="display:none">
				...
				<button type="button" class="btn btn-success consignes2" onclick="correction1();" id="choix1"> son </button>
				<button type="button" class="btn btn-success consignes2" onclick="correction2();" id="choix2"> sont </button>
