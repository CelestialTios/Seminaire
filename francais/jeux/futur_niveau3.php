<html> 	
	...
	<script type="text/javascript" src="futur_niveau3.js"></script>
	...
	<body onload="jecoute();">
		...
		<nav aria-label="breadcrum">
			<ol class="breadcrumb bg-danger">
				<li class="breadcrumb-item active text-white font-weight-bold titre" aria-current="page">Français - Conjugaison - Les verbes au futur - niveau 3</li>
			</ol>
		</nav>		
		<br>		
