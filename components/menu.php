<html> 
	<head>
		...
		<link rel="icon" href="/Seminaire/Content/img/favico.png" />
		<link href="/Seminaire/Content/css/custom.css" rel="stylesheet">
		<link href="/Seminaire/Content/css/all.css" rel="stylesheet">
		<script src="/Seminaire/Content/js/popper.min.js"></script>
		<script src="/Seminaire/Content/js/jquery.min.js"></script>
		<script src="/Seminaire/Content/js/bootstrap.min.js"></script>
			...
			<div class="btn-group d-flex menu" role="group" aria-label="Basic example">
				...
				<div class="btn-group" role="group">
					...
					<div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
						<a class="dropdown-item" href="/Seminaire/cours/francais/lecons/francais_lecons.php">Leçons</a>
						<a class="dropdown-item" href="/Seminaire/cours/dictee/francais_dictees.php">Dictées</a>
						<a class="dropdown-item" href="/Seminaire/jeux/francais/francais_jeux.php">Jeux</a>
					</div>
				</div>
				...
				<div class="btn-group" role="group">
					...
					<div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
						<a class="dropdown-item" href="/Seminaire/cours/mathematiques/mathematiques_lecons.php">Leçons</a>
						<a class="dropdown-item" href="/Seminaire/jeux/mathematiques/mathematiques_jeux.php">Jeux</a>
					</div>
				</div>
				...
				<div class="btn-group" role="group">
					...
					<div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
						<a class="dropdown-item" href="/Seminaire/cours/anglais/anglais_lecons.php">Leçons</a>
						<a class="dropdown-item" href="/Seminaire/jeux/anglais/anglais_jeux.php">Jeux</a>					
					</div>
				</div>
				...
				<div class="btn-group" role="group">
					...
					<div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
						<a class="dropdown-item" href="/Seminaire/cours/ddm/ddm_lecons.php">Leçons</a>
						<a class="dropdown-item" href="/Seminaire/jeux/ddm/ddm_jeux.php">Jeux</a>					
					</div>
				</div>
				...
				<div class="btn-group" role="group">
					...
					<div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
						<a class="dropdown-item" href="/Seminaire/classe/rituel.php">Devoirs</a>
						<a class="dropdown-item" href="/Seminaire/classe/quadrillage.php">Quadrillage</a>
						<a class="dropdown-item" href="/Seminaire/classe/ecriture.php">Ecriture</a>
						<a class="dropdown-item" href="/Seminaire/classe/tbi.php">TBI</a>
						<a class="dropdown-item" href="/Seminaire/photos/photos.php">Photos</a>
					</div>
				</div>
