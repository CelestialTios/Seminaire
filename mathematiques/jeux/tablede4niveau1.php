<html>
	<head>
		...
		<meta name="description" content="Jeu de la table de multiplication de 4, niveau découverte" />
		<meta charset="utf-8" />
		<title>Table des 4 niveau découverte</title>
	</head>
<?php
			include 'menu.php';
		?>
	...
	<body onload="rebours();">
		...
		<div id="encore" style="display:none;position:absolute; top:200px;left:300px">
			<form action="tablede4niveau1.php" method="POST">
