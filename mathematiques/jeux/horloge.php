...
<body>
		...
		<button type="button" class="btn btn-success consignes2"><label class="labelBtB" for="typInterne">Horloge interne</label>
			<input type="radio" id="typInterne" name="typActivite" value="typInterne" checked="checked"></button>

		<button type="button" class="btn btn-success consignes2"><label class="labelBtB" for="typInteractive">Manipuler</label>
			<input type="radio" id="typInteractive" name="typActivite" value="typInteractive"></button>

		<button type="button" class="btn btn-success consignes2"><label class="labelBtB" for="typExercices" data-toggle="dropdown">Exercices</label>
			<input type="radio" id="typExercices" name="typActivite" value="typExercices"></button>
			
		<button type="button" class="btn btn-success consignes2"><label class="labelBtBc" for="typEcrire">Ecrire l'heure</label>
									<input type="radio" id="typEcrire" name="typExercice" value="typEcrire" checked="checked"></button>
			
		<button type="button" class="btn btn-success consignes2"><label class="labelBtBc" for="typAiguilles">Placer les aiguilles</label>
									<input type="radio" id="typAiguilles" name="typExercice" value="typAiguilles"></button><br><br><br><br>
	...
	<div id="mainpage">
		<main>
								...
								<div id="digitalBox">
									...
									<div id="digitInterne">
										<div id="digHreBox">
											...
											<div class="slidBox">
												<div id="sliderHre" class="slid">
													<div id="handHre" class="ui-slider-handle slidHandle"></div>
												</div>
											</div>
										</div>
										...
										<div id="digMinBox">
											...
											<div class="slidBox">
												<div id="sliderMin" class="slid">
													<div id="handMin" class="ui-slider-handle slidHandle"></div>
												</div>
											</div>
										</div>
										...
										<div id="digSecBox">
											...
											<div class="slidBox">
												<div id="sliderSec" class="slid">
													<div id="handSec" class="ui-slider-handle slidHandle"></div>
												</div>
											</div>
										</div>
									</div>
									...
									<div id="digitAig">
										...
										<span class="sepDigit2"> : </span>
										<div id="digAigSec" class="inlBlk">00</div>					
									</div>							
			...
			<script src="jeux_conf/grandeurs/horloge/0.5.3/js/localstorage.js"></script>
