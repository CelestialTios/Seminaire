...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<link rel="stylesheet" type="text/css" href="jeux_conf/calcul-ecrit/soustraction-compensation/0.0.6/css/style.css">
	<link rel="stylesheet" type="text/css" href="jeux_conf/calcul-ecrit/soustraction-compensation/0.0.6/css/responsive.css">
	...
	<meta property="og:title" content="Calcul écrit : la soustraction" />
...
<body class="body">
	...
	<div id="mainpage">
		...
		<button type="button" class="btn btn-success consignes" id="consigne">Complète la soustraction ci-dessous</button><br>
		<br><br>
					<button type="button">
					<div id="plato">
						<div class="plato-1-1">
						...
						<button type="button" class="btn btn-info consignes">
								...
								<table id="tblOp">
									...
									<tr>
										...
										<td><input type="checkbox" id="chk1D" name="chk1D"></td>
										<td><input type="checkbox" id="chk1U" name="chk1U"></td>
									</tr>
									<tr>
										<td><input type="checkbox" id="chk2M" name="chk2M"></td>
										<td><input type="checkbox" id="chk2C" name="chk2C"></td>
										<td><input type="checkbox" id="chk2D" name="chk2D"></td>
										<td><input type="checkbox" id="chk2U" name="chk2U"></td>
									</tr>
								</table>
								<table id="tblOpD">
									<tr>
									...
									<tr>
										<td>,</td>
										<td><input type="checkbox" id="chk1Ud" name="chk1Ud"></td>
										<td><input type="checkbox" id="chk1Uc" name="chk1Uc"></td>
										<td><input type="checkbox" id="chk1Um" name="chk1Um"></td>
									</tr>
									<tr>
										<td>,</td>
										<td><input type="checkbox" id="chk2Ud" name="chk2Ud"></td>
			...
			<script src="jeux_conf/calcul-ecrit/soustraction-compensation/0.0.6/js/exercices.js"></script>
			<script src="jeux_conf/calcul-ecrit/soustraction-compensation/0.0.6/js/localstorage.js"></script>
			<script src="jeux_conf/calcul-ecrit/soustraction-compensation/0.0.6/js/app.js"></script>		</main>
