...
<script type="text/javascript" src="encadrer_niveau2.js"></script>
...
<script src="../../js/bootstrap.min.js"></script>
	...
	<div>
		<div class="presentation">
			...
			<button class="btn btn-success consignes" type="button" id="consigne">Encadre à la dizaine inférieur et à la dizaine supérieur.</button>
