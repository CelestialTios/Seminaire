...
<script type="text/javascript" src="duc_niveau2.js"></script>
...
<script src="../../js/bootstrap.min.js"></script>
	...
	<div>
		<div class="presentation">
			...
			<button class="btn btn-success consignes" type="button" id="consigne">Indique quel est le chiffre des centaines, des dizaines et des unités</button>
			...
			<button class="btn btn-success consignes2" type="button">centaine(s)</a></button><INPUT type="Nom du champ" placeholder="?" id="reponse1"></input>

			<button class="btn btn-success consignes2" type="button">dizaine(s)</a></button><INPUT type="Nom du champ" placeholder="?" id="reponse2"></input>

			<button class="btn btn-success consignes2" type="button">unité(s)</a></button><INPUT type="Nom du champ" placeholder="?" id="reponse3"></input>
			</div>
			...
			<button class="btn btn-success consignes2" type="button">centaine(s)</a></button><INPUT type="Nom du champ" placeholder="?" id="reponse4"></input>

			<button class="btn btn-success consignes2" type="button">dizaine(s)</a></button><INPUT type="Nom du champ" placeholder="?" id="reponse5"></input>

			<button class="btn btn-success consignes2" type="button">unité(s)</a></button><INPUT type="Nom du champ" placeholder="?" id="reponse6"></input>
			</div>
			...
			<button class="btn btn-success consignes2" type="button">centaine(s)</a></button><INPUT type="Nom du champ" placeholder="?" id="reponse7"></input>

			<button class="btn btn-success consignes2" type="button">dizaine(s)</a></button><INPUT type="Nom du champ" placeholder="?" id="reponse8"></input>

			<button class="btn btn-success consignes2" type="button">unité(s)</a></button><INPUT type="Nom du champ" placeholder="?" id="reponse9"></input>
			</div>
			...
			<button class="btn btn-success consignes2" type="button">centaine(s)</a></button><INPUT type="Nom du champ" placeholder="?" id="reponse10"></input>

			<button class="btn btn-success consignes2" type="button">dizaine(s)</a></button><INPUT type="Nom du champ" placeholder="?" id="reponse11"></input>

			<button class="btn btn-success consignes2" type="button">unité(s)</a></button><INPUT type="Nom du champ" placeholder="?" id="reponse12"></input>
			</div>
			...
			<button class="btn btn-success consignes2" type="button">centaine(s)</a></button><INPUT type="Nom du champ" placeholder="?" id="reponse13"></input>

			<button class="btn btn-success consignes2" type="button">dizaine(s)</a></button><INPUT type="Nom du champ" placeholder="?" id="reponse14"></input>

			<button class="btn btn-success consignes2" type="button">unité(s)</a></button><INPUT type="Nom du champ" placeholder="?" id="reponse15"></input>
			</div>
