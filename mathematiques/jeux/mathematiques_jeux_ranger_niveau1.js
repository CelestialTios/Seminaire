...
function go()
{
		...
		nbr1=Math.floor(Math.random()*50);
		while(true)
		{
		nbr2=Math.floor(Math.random()*50);
			if (nbr2!==nbr1)
			{
			break;
			}
		...
		while(true)
		{
		nbr3=Math.floor(Math.random()*50);
		...
		while(true)
		{
		nbr4=Math.floor(Math.random()*50);
		...
		while(true)
		{
		nbr5=Math.floor(Math.random()*50);
