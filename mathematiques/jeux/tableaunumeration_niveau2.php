...
<script type="text/javascript" src="tableaunumeration_niveau2.js"></script>
...
<script src="../../js/bootstrap.min.js"></script>
	...
	<div>
		<div class="presentation">
			...
			<button class="btn btn-success consignes" type="button" id="consigne">Ecris les chiffres des centaines, des dizaines et des unités dans la bonne colonne.</button>
