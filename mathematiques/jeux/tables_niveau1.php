<html>
	<head>
		...
		<meta name="description" content="Jeu de la table de multiplication de 2, niveau découverte" />
		<meta charset="utf-8" />
		<title>Tables, niveau découverte</title>
	</head>
<?php
			include 'menu.php';
		?>
	...
	<body onload="rebours();">
		...
		<div id="encore" style="display:none;position:absolute; top:200px;left:300px">
			<form action="tablede2niveau1.php" method="POST">
