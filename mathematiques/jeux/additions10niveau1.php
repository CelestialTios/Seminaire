<html>
	<head>
		...
		<meta name="description" content="Jeu d'addition du 10, niveau découverte" />
		<meta charset="utf-8" />
		<title>Addition de 10 niveau découverte</title>
	</head>
<?php
			include 'menu.php';
		?>
	...
	<body onload="rebours();">
		...
		<div id="encore" style="display:none;position:absolute; top:200px;left:300px">
			<form action="addition10niveau1.php" method="POST">
