<html>
	<head>
		...
		<meta name="description" content="Jeu d'addition du 10, niveau difficile" />
		<meta charset="utf-8" />
		<title>Addition de 10 niveau difficile</title>
	</head>
<?php
			include 'menu.php';
		?>
	...
	<body onload="rebours();">
		...
		<div id="encore" style="display:none;position:absolute; top:200px;left:300px">
			<form action="addition10niveau2.php" method="POST">
