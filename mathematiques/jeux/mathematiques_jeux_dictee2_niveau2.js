...
var vMot19="19";
var vMot20="20";
var lequel1=0; select=0; valid=0;lequel2=0;valid2=0;lequel3=0;valid3=0;lequel4=0;valid4=0;lequel5=0;valid5=0;lequel6=0;valid6=0;lequel7=0;valid7=0;lequel8=0;valid8=0;lequel9=0;valid9=0;lequel10=0;valid10=0;lequel11=0;valid11=0;lequel12=0;valid12=0;lequel13=0;valid13=0;lequel14=0;valid14=0;lequel15=0;valid15=0;lequel16=0;valid16=0;lequel17=0;valid17=0;lequel18=0;valid18=0;lequel19=0;valid19=0;lequel20=0;valid20=0;note=0;efface2=0;efface3=0;tour=1;
...
function jecoute()
		...
		switch (tour)
		{
			case 1 :
				...
				if (lequel1===0)
				{
				lettre=Math.floor(Math.random()*20)+1; 
				lequel1++;
				}
				switch(lettre)
				{
			...
			case 2 :
				...
				if (lequel2===0)
				{
				lettre2=Math.floor(Math.random()*20)+1; 
				lequel2++;
				}
				if(lettre2===lettre)
				{
			...
			case 3 :
				...
				if (lequel3===0)
				{
				lettre3=Math.floor(Math.random()*20)+1; 
				lequel3++;
				}
			...
			case 4 :
				...
				while(true)
				{
					if (lequel4===0)
				{
				lettre4=Math.floor(Math.random()*20)+1; 
				lequel4++;
				}
			...
			case 5 :
				...
				while(true)
				{
					if (lequel5===0)
				{
				lettre5=Math.floor(Math.random()*20)+1; 
				lequel5++;
				}
			...
			case 6 :
				...
				while(true)
				{
					if (lequel6===0)
				{
				lettre6=Math.floor(Math.random()*20)+1; 
				lequel6++;
				}
			...
			case 7 :
				...
				while(true)
				{
					if (lequel7===0)
				{
				lettre7=Math.floor(Math.random()*20)+1; 
				lequel7++;
				}
			...
			case 8 :
				...
				while(true)
				{
					if (lequel8===0)
				{
				lettre8=Math.floor(Math.random()*20)+1; 
				lequel8++;
				}
			...
			case 9 :
				...
				while(true)
				{
					if (lequel9===0)
				{
				lettre9=Math.floor(Math.random()*20)+1; 
				lequel9++;
				}
			...
			case 10 :
				...
				if (lequel10===0)
				{
				lettre10=Math.floor(Math.random()*20)+1; 
				lequel10++;
				}
