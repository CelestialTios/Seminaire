...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<link rel="stylesheet" type="text/css" href="jeux_conf/calcul-ecrit/soustraction/0.0.6/css/style.css">
	<link rel="stylesheet" type="text/css" href="jeux_conf/calcul-ecrit/soustraction/0.0.6/css/responsive.css">
...
<body class="body">
	...
	<div id="mainpage">
		...
		<br><br>
			...
			<script src="jeux_conf/calcul-ecrit/soustraction/0.0.6/js/exercices.js"></script>
			<script src="jeux_conf/calcul-ecrit/soustraction/0.0.6/js/localstorage.js"></script>
			<script src="jeux_conf/calcul-ecrit/soustraction/0.0.6/js/app.js"></script>		</main>
