...
function generer() {
	...
	if (typInconnu=="2emT") {
		$("#depoCompo").html("").append('<div id="calculBox"><div id="calcul">'+n1+' x <input type="tel" id="prop" value="" maxlength="6"> = '+total+'</div><div id="soluc">'+n2+'</div></div>');
	}
	else if (typInconnu=="1erT") {
		$("#depoCompo").html("").append('<div id="calculBox"><div id="calcul"><input type="tel" id="prop" value="" maxlength="6"> x '+n2+' = '+total+'</div><div id="soluc">'+n1+'</div></div>');
	}
