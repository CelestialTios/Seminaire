...
function generer() {
	...
	$("#depoCompo").html("").append('<div id="calculBox"><div id="calcul">'+total+' : '+n2+' = </div> <input type="tel" id="prop" value="" maxlength="3"><div id="soluc">'+n2+'</div></div>');

	$("#prop").css("width", ($("#soluc").width()+120)+'px');
