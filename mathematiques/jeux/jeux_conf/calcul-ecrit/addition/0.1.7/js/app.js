$(document).ready(function()
{
	...
	$("#chk3M").change(function(){
		chk3M = $(this).prop("checked");
		generer();
	});

	$("#chk3C").change(function(){
		chk3C = $(this).prop("checked");
		generer();
	});

	$("#chk3D").change(function(){
		chk3D = $(this).prop("checked");
		generer();
	});

	$("#chk3U").change(function(){
		chk3U = $(this).prop("checked");
		generer();
	});
	...
	$("#chk3Ud").change(function(){
		chk3Ud = $(this).prop("checked");
		generer();
	});

	$("#chk3Uc").change(function(){
		chk3Uc = $(this).prop("checked");
		generer();
	});

	$("#chk3Um").change(function(){
		chk3Um = $(this).prop("checked");
		generer();
	});
	...
	if ($('#hdBox').length && $('#pseudoHd').html()!='')
	{
		...
		else
		{
			sessUser = false;
			sessProf = true;
			pseudoL = "calcul-ecrit-addition-"+$('#pseudoHd').html();
	...
	else
	{
		...
		pseudoL = "calcul-ecrit-addition-"+pseudo;
		lireStorageApparence();
		lireStorageProfil();
		verifStor();
	}
...
function lireOptions() {
	...
	if (chk3M==true) {$("#chk3M").prop("checked", true);} else {$("#chk3M").prop("checked", false);}
	if (chk3C==true) {$("#chk3C").prop("checked", true);} else {$("#chk3C").prop("checked", false);}
	if (chk3D==true) {$("#chk3D").prop("checked", true);} else {$("#chk3D").prop("checked", false);}
	if (chk3U==true) {$("#chk3U").prop("checked", true);} else {$("#chk3U").prop("checked", false);}
	...
	if (chk3Ud==true) {$("#chk3Ud").prop("checked", true);} else {$("#chk3Ud").prop("checked", false);}
	if (chk3Uc==true) {$("#chk3Uc").prop("checked", true);} else {$("#chk3Uc").prop("checked", false);}
	if (chk3Um==true) {$("#chk3Um").prop("checked", true);} else {$("#chk3Um").prop("checked", false);}
