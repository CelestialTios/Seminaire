<html>
	<head>
		...
		<meta name="description" content="Jeu des doubles, niveau expert" />
		<meta charset="utf-8" />
		<title>Les doubles niveau expert</title>
	</head>
<?php
			include 'menu.php';
		?>
	...
	<body onload="rebours();">
		...
		<div id="encore" style="display:none;position:absolute; top:200px;left:300px">
			<form action="doublesniveau3.php" method="POST">
...
function go()
{
	...
	{
		document.getElementById("operation").innerHTML="Le double de "+listehasard[nbroperation]+" est ?";
	}
