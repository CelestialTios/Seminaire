...
function go()
{
		...
		{
		case 1 :
		nbr1=Math.floor(Math.random()*9999)+1;
		...
		case 2 :
		nbr2=Math.floor(Math.random()*9999)+1;
		...
		case 3 :
		nbr3=Math.floor(Math.random()*9999)+1;
		...
		case 4 :
		nbr4=Math.floor(Math.random()*9999)+1;
		...
		case 5 :
		nbr5=Math.floor(Math.random()*9999)+1;
...
function correction1()
{
		...
		switch(tour)
		{
			...
			var juste1=100*Math.floor(nbr1/100);juste2=100*Math.floor(nbr1/100)+100;
			...
			var juste3=100*Math.floor(nbr2/100);juste4=100*Math.floor(nbr2/100)+100;
			...
			var juste5=100*Math.floor(nbr3/100);juste6=100*Math.floor(nbr3/100)+100;
			...
			var juste7=100*Math.floor(nbr4/100);juste8=100*Math.floor(nbr4/100)+100;
			...
			var juste9=100*Math.floor(nbr5/100);juste10=100*Math.floor(nbr5/100)+100;
